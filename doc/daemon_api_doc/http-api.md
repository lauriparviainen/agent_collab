...
The machine-readable contract is [openapi.json](openapi.json). Regenerate both files with `./agent_collab.sh setup`; verify them without writes using `./agent_collab.sh setup --check`.
